...
const QRCODE_PLACEHOLDER = exports.QRCODE_PLACEHOLDER = "{{credentialSubject/qrCodeImage}}";
const BENEFITS_PLACEHOLDER_REGEX_PATTERN = exports.BENEFITS_PLACEHOLDER_REGEX_PATTERN = "\\{\\{credentialSubject/benefitsLine\\d+\\}\\}";
const BENEFITS_FIELD_NAME = exports.BENEFITS_FIELD_NAME = "benefits";
const FULL_ADDRESS_PLACEHOLDER_REGEX_PATTERN = exports.FULL_ADDRESS_PLACEHOLDER_REGEX_PATTERN = "\\{\\{credentialSubject/fullAddressLine\\d+/[a-zA-Z]+\\}\\}";
